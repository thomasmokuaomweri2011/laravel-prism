<?php $__env->startSection('content'); ?>
    <div class="w-full max-w-4xl h-[85vh] mx-auto flex flex-col bg-white/80 backdrop-blur-lg border border-white/30 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div class="flex-1 overflow-y-auto p-8 space-y-6 bg-white/70">
            <?php $__empty_1 = true; $__currentLoopData = ($brochures ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="p-6 rounded-2xl border border-gray-200 bg-white/80 shadow-sm hover:shadow-md transition-all">
                    <h3 class="text-xl font-semibold text-gray-900 mb-2">
                        <?php echo e($b['english']['title'] ?? 'Untitled Brochure'); ?>

                    </h3>
                    <?php if(!empty($b['english']['tagline'])): ?>
                        <p class="text-gray-600 mb-4"><?php echo e($b['english']['tagline']); ?></p>
                    <?php endif; ?>

                    <a href="<?php echo e(route('brochure.download', ['index' => $i])); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/thomasomweri/Sites/laravel-prism/resources/views/brochure/generated.blade.php ENDPATH**/ ?>